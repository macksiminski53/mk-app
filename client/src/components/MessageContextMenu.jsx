...
// only) / React (opens an inline emoji grid) / Pin-Unpin. Positioned at the
// click coordinates (already clamped to stay on-screen by the caller).
// Closes on an outside click, Escape, or after any action is taken.
export default function MessageContextMenu({ x, y, canEdit, pinned, onReply, onEdit, onReact, onPin, onClose }) {
